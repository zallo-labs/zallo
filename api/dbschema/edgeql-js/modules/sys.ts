...
const TransactionIsolation: $TransactionIsolation = $.makeType<$TransactionIsolation>(_.spec, "057aa557-e09f-11ed-ae94-7b41ca92c842", _.syntax.literal);
...
const VersionStage: $VersionStage = $.makeType<$VersionStage>(_.spec, "057b6027-e09f-11ed-875f-4fa9c4d3c26c", _.syntax.literal);
...
const $SystemObject = $.makeType<$SystemObject>(_.spec, "057c1422-e09f-11ed-a119-374c314a08b7", _.syntax.literal);
...
const $Database = $.makeType<$Database>(_.spec, "059d1ee0-e09f-11ed-974b-2d01443cc4c7", _.syntax.literal);
...
const $ExtensionPackage = $.makeType<$ExtensionPackage>(_.spec, "05c29591-e09f-11ed-8bcc-4b9d1ff04096", _.syntax.literal);
...
const $Role = $.makeType<$Role>(_.spec, "05ed2f8e-e09f-11ed-88ac-25e9c57ad6d0", _.syntax.literal);
...
function get_version(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('sys::get_version', args, _.spec, [
    {args: [], returnTypeId: "5cba775f-599e-1fa7-a919-19ad48eeb130"},
  ]);
...
function get_transaction_isolation(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('sys::get_transaction_isolation', args, _.spec, [
    {args: [], returnTypeId: "057aa557-e09f-11ed-ae94-7b41ca92c842"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
