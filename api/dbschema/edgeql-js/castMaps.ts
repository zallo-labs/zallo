...
export type scalarAssignableBy<T extends $.ScalarType> =
  ...
  T extends _default.$id_7c30129d784511eeb379798c114047f5 ? _default.$id_7c30129d784511eeb379798c114047f5 : 
...
type getSharedParentScalar<A, B> =
  ...
  A extends _default.$current_accounts_set ?
    ...
    never
  :
  A extends _default.$id_7c30129d784511eeb379798c114047f5 ?
    B extends _default.$id_7c30129d784511eeb379798c114047f5 ?
    B
    :
    never
  :
