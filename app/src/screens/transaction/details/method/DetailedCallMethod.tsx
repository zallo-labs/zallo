...
import { UPSERT_USER_SIGHSAH, useContractMethod } from '~/queries/useContractMethod.api';
...
export const DetailedCallMethod = memo(({ proposal: p, style }: DetailedCallMethodProps) => {
  ...
  if (method.sighash === UPSERT_USER_SIGHSAH) return <UpsertUserMethod call={p} style={style} />;

  if (method.sighash === REMOVE_USER_SIGHASH) return <RemoveUserMethod call={p} style={style} />;
