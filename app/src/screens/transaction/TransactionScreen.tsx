...
import { TransactionContextProps, TransactionProvider } from './TransactionProvider';

export interface TransactionScreenParams extends Omit<TransactionContextProps, 'children'> {}

export type TransactionScreenProps = RootNavigatorScreenProps<'Proposal'>;

export const TransactionScreen = withSkeleton(({ route }: TransactionScreenProps) => {
