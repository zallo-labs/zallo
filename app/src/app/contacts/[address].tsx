...
export type ContactScreenRoute = `/contacts/[address]`;
export type ContactScreenParams = SearchParams<ContactScreenRoute>;

export default function ContactScreen() {
  const params = useLocalSearchParams<ContactScreenParams>();
  return <InternalContactScreen address={asAddress(params.address)} />;
}
