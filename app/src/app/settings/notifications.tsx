...
export type NotificationSettingsScreenRoute = `/settings/notifications`;
export type NotificationSettingsScreenParams = { onboard?: 'true' };

export default function NotificationSettingsScreen() {
  const onboard = useLocalSearchParams<NotificationSettingsScreenParams>().onboard === 'true';
  const [settings, update] = useImmerAtom(NOTIFICATIONS_ATOM);
  const createFirstAccount = useCreateFirsAccount();
  const next = onboard ? createFirstAccount : undefined;
