...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(drawer)/_layout` | `/_layout` | `/(drawer)/contacts/add` | `/contacts/add` | `/(drawer)/contacts/` | `/contacts/` | `/(drawer)/contacts` | `/(drawer)/ledger/link` | `/ledger/link` | `/(drawer)/sessions/` | `/sessions/` | `/(drawer)/sessions` | `/(drawer)/settings/auth` | `/settings/auth` | `/(drawer)/settings/notifications` | `/settings/notifications` | `/(drawer)/token/add` | `/token/add` | `/(drawer)/user` | `/user` | `/accounts/create` | `/accounts/` | `/addresses` | `/confirm` | `/ledger/sign` | `/link/` | `/link/token` | `/onboard/approver` | `/onboard/auth` | `/onboard/` | `/onboard/notifications` | `/onboard/user` | `/scan/`;
  // prettier-ignore
