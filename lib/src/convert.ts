...
import { BigIntlike } from './bigint';

export const FIAT_DECIMALS = 16;

export function tokenToToken(amount: BigIntlike, curDecimals: number, newDecimals: number): bigint {
...
export function tokenToFiat(amount: BigIntlike, price: number, decimals: number): number {
